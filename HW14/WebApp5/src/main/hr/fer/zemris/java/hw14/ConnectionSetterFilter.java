...
/**
 * Filters connections from all servlets and for each creates new connection to data persistence provider.
 */
@WebFilter(filterName="connectToDatabase",urlPatterns={"/*"})
