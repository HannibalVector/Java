...
public class ForLoopNode extends Node {
    ...
    /**
     * Generates {@code String} that represents standardized code which would get parsed to this {@code ForLoopNode}.
     * Overrides method {@code getOriginalText()} from parent class {@link Node}.
     * @return  {@code String} that represents code which would get parsed to this {@code ForLoopNode}.
     */
    @Override
    public String getOriginalText() {
        ...
        if(stepExpression != null) {
            originalTextBuilder.append(" ").append(stepExpression.asText());
        }
        originalTextBuilder
                .append(" $}")
                .append(getChildrenOriginalText())
                .append("{$ END $}");
